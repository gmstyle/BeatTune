...
package app.beattune.android.utils
...
import app.beattune.core.ui.utils.SongBundleAccessor
...
fun Uri?.toThumbnailUrl(size: Int) = toString().toThumbnailUrl(size)?.toUri()
