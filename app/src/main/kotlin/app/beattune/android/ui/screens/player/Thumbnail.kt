...
import app.beattune.android.service.LoginRequiredException
import app.beattune.android.service.PlayableFormatNotFoundException
import app.beattune.android.service.RestrictedVideoException
import app.beattune.android.service.UnplayableException
import app.beattune.android.service.VideoIdMismatchException
...
import app.beattune.android.utils.windowState
        ...
        if (currentWindow != null) Box(
            ...
            AsyncImage(
                model = currentWindow.mediaItem.mediaMetadata.artworkUri
                    ?.toThumbnailUrl((Dimensions.thumbnails.player.song - 64.dp).px),
